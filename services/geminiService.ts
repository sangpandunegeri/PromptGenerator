...
export const detectPromptFromImage = async (file: File, apiKey: string): Promise<string> => {
    ...
    const textPart = { text: "Jelaskan gambar ini secara detail, cocok untuk prompt video. Fokus pada subjek utama atau lingkungan. Deskripsikan secara naratif: 1. Identitas subjek/lokasi. 2. Detail visual utama (wajah, arsitektur, dll). 3. Pakaian atau elemen kunci lingkungan. 4. Aksesori atau detail atmosferik." };
